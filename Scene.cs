...
namespace Cludo_Engine
{
    public static class Extensions
    {
        public static Body ConvertToBody(this Texture2D me, Scene scene)
        {
            ...
            Debugging.Debug.WriteLine(
                "WARNING: In Texture2D.ConvertToBody, Body functions have not been implemented! See next two lines");
            body.Friction = 0f;
            body.IsStatic = true;
            return body;
        }
    ...
    public class Scene : IEngineFeature, IDisposable
    {
        ...
        public Scene(SpriteBatch sb, GraphicsDevice gd, GameWindow window, ContentManager content)
        {
            GraphicsDevice = gd;
            SpriteBatch = sb;
            Content = content;
